 ...
 * Complete Google Apps Script Bundle
 *
 * SETUP:
 * 1. Go to script.google.com → New Project
 * 2. Copy ALL of this code into Code.gs
 * 3. Click Deploy → New deployment → Web app → Execute as: Me → Access: Anyone in your org
 * 4. Copy the deployment URL
 * 5. Paste into Google Site: Insert → Embed URL
 * Done!
 */
